...
export default function Unidades() {
  ...
  const handleRegister = async () => {
    try {
      ...
      if (response.status === 200) {
        window.confirm("Unidade cadastrada com sucesso");
        setUnidadeData({
          nome: "",
          cidade: "",
          uf: "",
      ...
      window.confirm("Erro ao cadastrar unidade");
    }
  };
    ...
    <>
      <div id="unidades-main">
        <div className="unidades-title">
          ...
          <span className="unidades-title-subtext">Nesta seção você pode cadastrar e visualizar as unidades.</span>
        </div>
          ...
          <div className="infos-unidades">
            ...
            {visualizacao && (
              <div className="container-table-unidades">
                <Table striped bordered hover className="table-mercadorias" style={{ width: "100%", borderCollapse: "collapse" }}>
                  <thead>
                    <tr>
                      <th>Nome</th>
                      <th>Cidade</th>
            ...
            {cadastro && (
              <div className="container-table-unidades">
                <div className="form-movimento">
                  ...
                  ></input>
                  <button onClick={handleRegister} className="btn btn-primary mt-3">Cadastrar</button>
                </div>
              </div>
            )}
          </div>
